...
// SEO Priority: Volume=1300, Difficulty=9, Intent=Informational
...
export const metadata: Metadata = {
  title: '24 hour ac unit repair | Blume Service Group | ${PRIMARY_CITY} FL',
  description: 'Need help with 24 hour ac unit repair? Blume Service Group provides fast, reliable HVAC service in Tampa Bay. Available 24/7 for emergencies. Call now for same-day service.',
  openGraph: {
    title: '24 hour ac unit repair — Blume Service Group',
...
function JsonLd() {
  const schema = {
    ...
    serviceType: '24 hour ac unit repair',
    areaServed: {
      '@type': 'State',
      name: 'Florida',
    },
    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="prose prose-lg max-w-none mb-12">
          <h2>Why Tampa Bay Trusts Blume for 24 hour ac unit repair</h2>
          <p>
            When you need help with 24 hour ac unit repair, Blume Service Group is the name
          ...
          <h2>Service Areas</h2>
          <p>
            We provide 24 hour ac unit repair services across the Tampa Bay region including:
          </p>
          <ul>
            {CITIES.map((city) => (
        ...
        <section className="bg-blue-50 rounded-xl p-8 text-center mb-12">
          <h2 className="text-2xl font-bold mb-4">
            Need 24 hour ac unit repair Help Now?
          </h2>
