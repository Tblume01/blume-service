...
// SEO Priority: Volume=1000, Difficulty=9, Intent=Commercial
...
export const metadata: Metadata = {
  title: '24 hour hvac | Blume Service Group | ${PRIMARY_CITY} FL',
  description: 'Need help with 24 hour hvac? Blume Service Group provides fast, reliable HVAC service in Tampa Bay. Available 24/7 for emergencies. Call now for same-day service.',
  openGraph: {
    title: '24 hour hvac — Blume Service Group',
    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="prose prose-lg max-w-none mb-12">
          <h2>Why Tampa Bay Trusts Blume for 24 hour hvac</h2>
          <p>
            When you need help with 24 hour hvac, Blume Service Group is the name
          ...
          <h2>Service Areas</h2>
          <p>
            We provide 24 hour hvac services across the Tampa Bay region including:
          </p>
          <ul>
            {CITIES.map((city) => (
