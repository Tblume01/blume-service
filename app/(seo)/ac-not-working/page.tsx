...
// SEO Priority: Volume=4400, Difficulty=23, Intent=Informational
...
export const metadata: Metadata = {
  title: 'ac not working | Blume Service Group | ${PRIMARY_CITY} FL',
  description: 'Need help with ac not working? Blume Service Group provides fast, reliable HVAC service in Tampa Bay. Available 24/7 for emergencies. Call now for same-day service.',
  openGraph: {
    title: 'ac not working — Blume Service Group',
    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="prose prose-lg max-w-none mb-12">
          <h2>Why Tampa Bay Trusts Blume for ac not working</h2>
          <p>
            When you need help with ac not working, Blume Service Group is the name
          ...
          <h2>Service Areas</h2>
          <p>
            We provide ac not working services across the Tampa Bay region including:
          </p>
          <ul>
            {CITIES.map((city) => (
