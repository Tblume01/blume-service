...
// SEO Priority: Volume=1000, Difficulty=29, Intent=Informational
// Topic cluster: ac financing options
...
export const metadata: Metadata = {
  title: 'rent to own washer dryer rental | Blume Service Group | ${PRIMARY_CITY} FL',
  description: 'Need help with rent to own washer dryer rental? Blume Service Group provides fast, reliable HVAC service in Tampa Bay. Available 24/7 for emergencies. Call now for same-day service.',
  openGraph: {
    title: 'rent to own washer dryer rental — Blume Service Group',
...
function JsonLd() {
  const schema = {
    ...
    '@type': 'Service',
    name: 'rent to own washer dryer rental',
    provider: {
      '@type': 'LocalBusiness',
    ...
    serviceType: 'rent to own washer dryer rental',
    areaServed: {
      '@type': 'State',
      name: 'Florida',
    },
    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="prose prose-lg max-w-none mb-12">
          <h2>Why Tampa Bay Trusts Blume for rent to own washer dryer rental</h2>
          <p>
            When you need help with rent to own washer dryer rental, Blume Service Group is the name
          ...
          <h2>Service Areas</h2>
          <p>
            We provide rent to own washer dryer rental services across the Tampa Bay region including:
          </p>
          <ul>
            {CITIES.map((city) => (
        ...
        <section className="bg-blue-50 rounded-xl p-8 text-center mb-12">
          <h2 className="text-2xl font-bold mb-4">
            Need rent to own washer dryer rental Help Now?
          </h2>
        ...
        <nav className="border-t pt-8">
          ...
          <ul className="space-y-2">
            <li>
              <a href="/ac-financing-options" className="text-blue-600 hover:underline">
                ← ac financing options (all services)
              </a>
            </li>
            <li>
